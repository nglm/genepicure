...
1. **Infere causal gene-gene regulation using expression data and eQTL genotypes.** This step uses [**Findr**](https://github.com/lingfeiwang/findr)[^FINDR] for GRN reconstruction from genotype and transcriptome data.
...
2. 2 (or more) columns:
    1. SNP identifier (string) matching names the gene expression matrix
    2. Gene identifier (string) matching names in the genotype matrix.
